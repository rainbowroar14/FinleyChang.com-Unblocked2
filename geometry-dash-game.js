...
const $dist = document.getElementById("gdDist");
const $best = document.getElementById("gdBest");
const $scoreFill = document.getElementById("gdScoreFill");
const $scoreText = document.getElementById("gdScoreText");
const $zone = document.getElementById("gdZone");
const $zoneDot = document.getElementById("gdZoneDot");
const $speed = document.getElementById("gdSpeed");
const $dual = document.getElementById("gdDual");
const $formBtn = document.getElementById("gdFormBtn");
const $customBtn = document.getElementById("gdCustomBtn");
const $customPanel = document.getElementById("gdCustomPanel");
const $tightnessSelect = document.getElementById("gdTightnessSelect");
const $baseSpeedSelect = document.getElementById("gdBaseSpeedSelect");
const $ogModeSelect = document.getElementById("gdOgModeSelect");
const $skinSelect = document.getElementById("gdSkinSelect");
const $primaryColor = document.getElementById("gdPrimaryColor");
const $accentColor = document.getElementById("gdAccentColor");
const $trailColor = document.getElementById("gdTrailColor");
const $customClose = document.getElementById("gdCustomClose");
const $customReset = document.getElementById("gdCustomReset");
const $sectionsBtn = document.getElementById("gdSectionsBtn");
const $sectionsPanel = document.getElementById("gdSectionsPanel");
const $sectionsList = document.getElementById("gdSectionsList");
const $sectionsPlay = document.getElementById("gdSectionsPlay");
const $sectionsClose = document.getElementById("gdSectionsClose");
const $sectionsAll = document.getElementById("gdSectionsAll");
const $sectionsNone = document.getElementById("gdSectionsNone");
const $sectionsDefaults = document.getElementById("gdSectionsDefaults");
